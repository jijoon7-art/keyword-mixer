...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    'zodiac-calculator','love-calculator',
    'gpa-calculator','unit-price-calculator',
    'stamp-maker','bmi-calculator-pro','random-picker','uuid-generator',
    'word-frequency','text-to-table','json-validator','date-diff-calculator','reading-speed',
    'tax-refund','paint-calculator','concrete-calculator','lucky-number','biorhythm','mbti-compatibility',
