...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const tools = [
    ...
    'loan-comparison','retirement-calculator','real-estate-tax','freelancer-tax',
    ...
    'gpa-calculator','unit-price-calculator','date-diff-calculator','reading-speed',
    'tax-refund','paint-calculator','concrete-calculator',
    ...
    'tax-calculator','salary-calculator','compound-interest','loan-repayment-table',
    'statistics-calculator','savings-calculator','stock-calculator','jeonse-calculator',
    'subscription-calculator','currency-premium',
    'lotto','id-generator','number-to-korean',
    'payslip-generator','invoice-generator',
    'body-fat-calculator','blood-pressure-tracker','calorie-food-search','exercise-calorie',
    'nutrition-calculator','sleep-calculator','steps-calorie','blood-sugar-tracker',
    'menstrual-calculator','baby-development','height-predictor',
    ...
    'unit-converter','timezone-converter','timer','password-generator','qr-generator',
    'color-palette','color-converter','color-contrast','color-temperature','internet-speed-converter',
  ]
  return [
