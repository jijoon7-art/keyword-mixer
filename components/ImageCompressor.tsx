...
export default function ImageCompressor() {
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-10">
      ...
      <ToolFooter
        toolName="이미지 압축기"
        toolUrl="https://keyword-mixer.vercel.app/image-compressor"
        description="이미지 용량 무료 압축. JPG·PNG·WebP 지원, 여러 장 동시 압축."
        howToUse={[
          { step: '도구 접속', desc: '이미지 압축기에 접속하세요.' },
        ...
        keywords="이미지 압축기 · 이미지 용량 줄이기 · 사진 압축 · JPG 압축 · PNG 압축 · image compressor · compress image online · reduce image size · free image compression"
      />
    </div>
  )
}
