...
export default function TimerStopwatch() {
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-10">
      ...
      <ToolFooter
        toolName="타이머 / 스톱워치"
        toolUrl="https://keyword-mixer.vercel.app/timer"
        description="카운트다운 타이머·스톱워치·포모도로 타이머."
        howToUse={[
          { step: '도구 접속', desc: '타이머 / 스톱워치에 접속하세요.' },
        ...
        keywords="타이머 · 스톱워치 · 카운트다운 타이머 · 포모도로 타이머 · 공부 타이머 · online timer · stopwatch · countdown timer · pomodoro timer"
      />
    </div>
  )
}
